 ...
 */
final class Version20230215094644 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student (nsc INT NOT NULL, classroom_id INT DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, INDEX IDX_B723AF336278D5A8 (classroom_id), PRIMARY KEY(nsc)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
